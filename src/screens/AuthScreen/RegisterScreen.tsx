  ...
  return (
    <View style={[styles.container ,{backgroundColor:Colors.background}]}>
      <View style={[styles.overlay , {backgroundColor:Colors.background}]}>
        <TextInput
          style={[styles.input , {backgroundColor:Colors.secondary , color:Colors.text , marginBottom: 20}]}
        ...
        <View style={{flexDirection: 'column', alignItems: 'flex-start'}}>
          <View style={styles.passwordContainer}>
            <TextInput
              style={[styles.input, styles.input2 , {color:Colors.text , backgroundColor:Colors.secondary}]}
          ...
          {passwordError ? (
            ...
            <Text style={{color:Colors.text}}>password must contain 6 characters</Text>
          )}
        </View>
